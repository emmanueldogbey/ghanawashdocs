...
cards <- docs_meta %>%
  ...
  mutate(
    card = glue('
<div class="card" data-year="{meta_year}" data-sector="{meta_sector}">
  <div class="card-body">
...
document.addEventListener("DOMContentLoaded", function() {{
  ...
  function filterCards() {{
    ...
    cards.forEach(card => {{
      ...
      card.style.display = (matchYear && matchSector) ? "" : "none";
    }});
  }}
...
<div class="byline" style="margin-top:2rem; text-align:center; font-size:0.9em; color:#555;">
  ...
  <a href="https://github.com/emmanueldogbey/ghanawashdocs.github.io" target="_blank" style="margin-left:8px;">
